...
def restdoss(L):
    infdoss = ['N° Patient BROUSSAIS' , 'Date de naissance' , 'Sexe du patient','Code postal du patient' ,'Date de prélèvement de dossier', 'Nom du prescripteur' ,  '94558-4','COV19_ARN_RR_PR_THF1_BPO' ,   'APSYM','XXX_DELAI_SYMPT']
    ...
    Q=Q[['N° Patient BROUSSAIS' , 'Date de naissance' , 'Sexe du patient','Code postal du patient' ,'Date de prélèvement de dossier', 'Nom du prescripteur' ,  '94558-4',   'APSYM']]
...
#pour bilan ops
SOPS=Statdatep.loc[[elt for elt in Statdatep.index if 'COVISAN' not in elt and 'VALIN' not in elt and 'Hôpital' not in elt  and 'MAISON SANTÉ' not in elt and 'HOPITAL' not in elt and 'Broussais' not in elt and 'CH4V' not in elt and 'Abondances' not in elt and 'FONDATION ROTHSCHILD' not in elt and 'UNIV PARIS' not in elt]]
