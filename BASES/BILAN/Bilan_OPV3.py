...
def restdoss(L):
    ...
    Q=Q[['N° Patient BROUSSAIS' , 'Date de naissance' , 'Sexe du patient','Code postal du patient' ,'Date de prélèvement de dossier', 'Nom du prescripteur' ,  '94500-6',   'APSYM']]
